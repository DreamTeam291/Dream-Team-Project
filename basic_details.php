...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `basic_details`(`id`, `user_code`, `name`, `address`, `email`, `mobile`, `profile`, `objective`, `declaration`) VALUES ('$id','$user_code','$name','$address','$email','$mobile','$profile','$objective','$declaration')";  
...
if(isset($_REQUEST['edit'])){
  ...
  //end of of varibale and value setting
  //start of typing  query
	$query = "UPDATE `basic_details` SET `id`='$id',`user_code`='$user_code',`name`='$name',`address`='$address',`email`='$email',`mobile`='$mobile',`profile`='$profile',`objective`='$objective',`declaration`='$declaration'";  
  // end of typing  query
	$message=iud_data($query);
  if($message=="sucess"){
		echo"<script>alert('data saved successfully ')</script>";
...
<div class="container">
  ...
  <td>
  <input type="text" name="id" class="form-control" value="<?php if($action=="edit"){echo $data['id'];}else{echo "";} ?>"  required="required">
  </td>
  </tr>
  <tr>
  ...
  <td>
  <input type="text" name="mobile" class="form-control" value="<?php if($action=="edit"){echo $data['mobile'];}else{echo "";} ?>"  required="required">
  </td>
  </tr>
  <tr>
