...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `experience_details`(`id`, `user_code`, `organization_name`, `experience`, `role`) VALUES ('$id','$user_code','$organization_name','$experience','$role')";  
...
if(isset($_REQUEST['edit'])){
  ...
  //end of of varibale and value setting
  //start of typing  query
	$query = "UPDATE `experience_details` SET `id`='$id',`user_code`='$user_code',`organization_name`='$organization_name',`experience`='$experience',`role`='$role' WHERE id='$id'";  
  // end of typing  query
	$message=iud_data($query);
  if($message=="sucess"){
		echo"<script>alert('data saved successfully ')</script>";
...
<div class="container">
  ...
  <td>
   <input type="text" name="id" id="name" class="form-control" value="<?php if($action=="edit"){ echo $data['id'];}else {echo "";} ?>" placeholder="Name" required="required" autofocus="autofocus">
  </td>
  </tr>
  <tr>
